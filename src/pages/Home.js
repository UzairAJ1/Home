            ...
            {showCircle ? (
              ...
              >
                ...
                <h1 className="text-xl font-bold">
                  Your home have been Qualified
                </h1>
                <h1>{places.label}</h1>
                <h1 className="text-red-500">($150,000)</h1>
                <h1>No closing cost,No comissions , No hidden fees</h1>
                <button
                  onClick={() => {
                    setForm(1);
                  }}
      ...
      >
        ...
        <div className="w-full h-full flex flex-col z-10 border-4 border-black">
          <video
            ...
            muted
            loop
            className="absolute left-0 w-full z-0 md:flex hidden border-4 border-red-500"
          >
